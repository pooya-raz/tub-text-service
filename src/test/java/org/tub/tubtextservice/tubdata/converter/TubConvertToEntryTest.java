package org.tub.tubtextservice.tubdata.converter;
...
class TubConvertToEntryTest {
  ...
  private ConvertToEntry subject;
  ...
  void setUpBeforeEach() {
    subject = new ConvertToEntry(manuscriptConverter, tubDateConverter, editionConverter);
